...
export const getOrgTeamRoutingFormsSchema = {
...
export async function getOrgTeamRoutingForms(params: {
  orgId: number;
  teamId: number;
  skip?: number;
  take?: number;
  ...
  try {
    ...
    const data = await calApi(`organizations/${params.orgId}/teams/${params.teamId}/routing-forms`, { params: qp });
    return ok(data);
  } catch (err) {
    return handleError("get_org_team_routing_forms", err);
  }
}

export const getOrgTeamRoutingFormResponsesSchema = {
  orgId: z.number().int().describe("orgId"),
  teamId: z.number().int().describe("teamId"),
...
export async function getOrgTeamRoutingFormResponses(params: {
  orgId: number;
  teamId: number;
  ...
  try {
    ...
    if (params.beforeUpdatedAt !== undefined) qp.beforeUpdatedAt = params.beforeUpdatedAt;
    if (params.routedToBookingUid !== undefined) qp.routedToBookingUid = params.routedToBookingUid;
    const data = await calApi(`organizations/${params.orgId}/teams/${params.teamId}/routing-forms/${params.routingFormId}/responses`, { params: qp });
    return ok(data);
  } catch (err) {
    return handleError("get_org_team_routing_form_responses", err);
  }
}

export const createOrgTeamRoutingFormResponseSchema = {
  orgId: z.number().int().describe("orgId"),
  teamId: z.number().int().describe("teamId"),
  routingFormId: z.string().describe("routingFormId"),
...
export async function createOrgTeamRoutingFormResponse(params: {
  orgId: number;
  teamId: number;
  routingFormId: string;
  start: string;
  ...
  try {
    const data = await calApi(`organizations/${params.orgId}/teams/${params.teamId}/routing-forms/${params.routingFormId}/responses`, { method: "POST", body: {} });
    return ok(data);
  } catch (err) {
    return handleError("create_org_team_routing_form_response", err);
  }
}

export const updateOrgTeamRoutingFormResponseSchema = {
  orgId: z.number().int().describe("orgId"),
  teamId: z.number().int().describe("teamId"),
  routingFormId: z.string().describe("routingFormId"),
...
export async function updateOrgTeamRoutingFormResponse(params: {
  orgId: number;
  teamId: number;
  routingFormId: string;
  responseId: number;
  ...
  try {
    ...
    const data = await calApi(`organizations/${params.orgId}/teams/${params.teamId}/routing-forms/${params.routingFormId}/responses/${params.responseId}`, { method: "PATCH", body });
    return ok(data);
  } catch (err) {
    return handleError("update_org_team_routing_form_response", err);
  }
}
