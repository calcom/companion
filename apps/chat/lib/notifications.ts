    ...
    children: [
      Section([
        ...
        Fields([
          ...
          Field({ label: "/cal notify on|off", value: "Enable or disable booking notifications" }),
    ...
    children: [
      Section([
        ...
        Fields([
          ...
          Field({ label: "/notify on · /notify off", value: "Enable or disable booking notifications" }),
